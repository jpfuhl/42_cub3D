...
static void	check_element(t_data *data, t_map *map, char *line)
{
	if (line[0] == 'N' && line[1] == 'O' && line[2] == ' ')
		set_texture(data, map, NORTH, &line[3]);
	else if (line[0] == 'S' && line[1] == 'O' && line[2] == ' ')
		set_texture(data, map, SOUTH, &line[3]);
	else if (line[0] == 'W' && line[1] == 'E' && line[2] == ' ')
		set_texture(data, map, WEST, &line[3]);
	else if (line[0] == 'E' && line[1] == 'A' && line[2] == ' ')
		set_texture(data, map, EAST, &line[3]);
...
static void	set_element(t_data *data, t_map *map, char *line)
{
	int	i;
